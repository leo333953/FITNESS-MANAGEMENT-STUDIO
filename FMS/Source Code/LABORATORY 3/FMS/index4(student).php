...
<head>
    ...
    <title>Fitness Studio - Student Athlete Form</title>
...
<div class="container">
    ...
    <div class="right">
        ...
        <form class="register-form" action="index1.6.html" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" placeholder="Course & Year" name="courseYear" required>
            </div>

            <div class="form-group">
                <input type="email" placeholder="Email" name="email" required>
                <input type="text" placeholder="Sports Expertise / Others" name="expertise" required>
            </div>
